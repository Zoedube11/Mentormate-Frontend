...
export default function BraVusiChat() {
  ...
  const collectionName = "Concrete_docs";
  ...
  const sendMessage = async () => {
    ...
    user_id: "bra-vusi-test-user-001",    
  };
    console.log("Bra Vusi RAG request body:", JSON.stringify(requestBody, null, 2));
      ...
      <div className="flex-1 p-4 flex justify-center">
        <div className="max-w-4xl w-full bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col">
          ...
          <div className="flex-1 p-6 space-y-4 overflow-y-auto max-h-[70vh]">
            {messages.map((m) => (
              ...
              >
                ...
                <div
                  className={`${
                    m.type === "user" ? "bg-gray-200 text-gray-900" : "bg-yellow-50 text-gray-900"
          ...
          <div className="p-4 border-t flex gap-2">
            ...
            <button
              onClick={sendMessage}
              className="bg-yellow-600 text-white px-6 py-2 rounded-full hover:bg-yellow-500 transition-colors"
            >
              Send
            </button>
          </div>
