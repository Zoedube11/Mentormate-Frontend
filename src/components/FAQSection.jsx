...
export default function FAQSection() {
 ...
 const faqs = [
  ...
  {
    question: "Does Mentormate store my data?",
    answer:
      "Mentormate embeds security and data-protection principles across every layer. We collect only minimal personal information for account creation and verification. No card numbers are stored; all payments are securely processed through PayFast. Any usage data is anonymised and never used to train large AI models. Our systems run on isolated, encrypted databases with hashed credentials, supported by strong network safeguards including rate-limiting and CSRF protection. Mentormate is fully aligned with POPIA, ensuring transparency, user privacy, and full protection of your rights.",
  },
];
        ...
        {faqs.map((faq, index) => (
          <div key={index} className="relative">
            ...
            >
              ...
              <span
                className={`transform transition-transform duration-300 ml-6 ${openIndex === index ? "rotate-180" : ""
                  }`}
              >
                ▼
              </span>
